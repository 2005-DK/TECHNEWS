    ...
    <div class="row py-4">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="font-weight-medium">
                <i class="fa fa-map-marker-alt mr-2"></i>{{ optional($global_settings)->address ?? '—' }}
            </p>
            <p class="font-weight-medium">
                <i class="fa fa-phone-alt mr-2"></i>{{ optional($global_settings)->phone ?? '—' }}
            </p>
            <p class="font-weight-medium">
                <i class="fa fa-envelope mr-2"></i>{{ optional($global_settings)->email ?? '—' }}
            </p>
            <h6 class="mt-4 mb-3 text-white text-uppercase font-weight-bold">
                Suivez nous
            </h6>
            <div class="d-flex justify-content-start">
                @if($global_social && $global_social->isNotEmpty())
...
>
        ...
        &copy; <a href="#">{{ optional($global_settings)->web_site_name ?? config('app.name') }}</a>. All Rights Reserved. Design by
